...
const CurlBarTriceps = () => {
    ...
    const Create = () => {
      ...
      ;
        ...
        addDoc(collection(db, "triceps_sztanga_skos"),docData)
          .then(()=>{
      ...
      const Read = () => {
        const myCollection = collection(db, 'triceps_sztanga_skos')
      ...
      const Delete = (id) => {
        const docRef = doc(db, 'triceps_sztanga_skos', id)
